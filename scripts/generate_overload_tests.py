...
from typing import get_args, get_origin, ForwardRef, List, Literal, Tuple, Union
...
def stream_cases_and_write_files(all_literals, mode: Literal["tuple", "iterable"]) -> int:
    ...
    for L in range(1, MAX_LEN + 1):
        PATH_WITHOUT_NUMBER = f"tests/typecheck/codec/decode/{FOLDER}/len_{L}/{FILENAME_PREFIX}"
        chunk_idx = 1
        chunk_lines = []
        file_counter = 0
