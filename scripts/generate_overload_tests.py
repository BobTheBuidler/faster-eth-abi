...
def compute_total_cases_sampled(all_literals: List["LiteralString"], max_len: int) -> int:
    n = len(all_literals)
...
def write_file(path: pathlib.Path, lines: List[str], impl: Literal["abi", "codec"]) -> None:
