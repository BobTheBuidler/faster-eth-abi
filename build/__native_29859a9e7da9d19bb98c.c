...
const int CPyLit_Tuple[] = {
    46, 4, 11, 12, 13, 14, 2, 16, 17, 2, 19, 20, 3, 11, 12, 14, 1, 23,
    ...
    215, 4, 162, 168, 166, 181, 1, 182, 6, 232, 233, 234, 210, 235, 236,
    1, 237, 1, 252, 3, 270, 270, 270, 1, 350, 4, 59, 272, 130, 14, 1, 275,
    1, 12
};
