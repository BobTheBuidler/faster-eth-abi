...
char CPyDef__codec_____top_level__(void) {
    ...
    CPy_DECREF(cpy_r_r4);
CPyL3: ;
    cpy_r_r5 = CPyStatics[229]; /* ('TYPE_CHECKING', 'Any', 'Iterable', 'Tuple') */
    ...
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = CPyStatics[230]; /* ('Decodable', 'TypeStr') */
    ...
    cpy_r_r13 = CPyStatics[231]; /* ('validate_bytes_param', 'validate_list_like_param') */
...
static PyMethodDef _decodingmodule_methods[] = {
    ...
    {"decoder_fn_string", (PyCFunction)CPyPy__decoding___decoder_fn_string, METH_FASTCALL | METH_KEYWORDS, PyDoc_STR("decoder_fn_string(data, handle_string_errors=\'strict\')\n--\n\n") /* docstring */},
    {NULL, NULL, 0, NULL}
};
...
CPyTagged CPyDef__decoding___decode_uint_256(PyObject *cpy_r_stream) {
    ...
    if (likely(PyBytes_Check(cpy_r_r4) || PyByteArray_Check(cpy_r_r4)))
        ...
        CPy_TypeErrorTraceback("faster_eth_abi/_decoding.py", "decode_uint_256", 38, CPyStatic__decoding___globals, "bytes", cpy_r_r4);
        goto CPyL13;
    }
    CPy_INCREF(cpy_r_r5);
...
PyObject *CPyPy__decoding___decode_uint_256(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_uint_256", 30, CPyStatic__decoding___globals);
    return NULL;
}
...
PyObject *CPyPy__decoding___get_value_byte_size(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retbox;
fail: ;
    CPy_AddTraceback("faster_eth_abi/_decoding.py", "get_value_byte_size", 43, CPyStatic__decoding___globals);
    return NULL;
}
...
CPyL2: ;
    ...
    if (unlikely(cpy_r_r7 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_head_tail", 55, CPyStatic__decoding___globals);
        goto CPyL11;
    }
...
CPyL4: ;
    ...
    if (unlikely(cpy_r_r13 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_head_tail", 57, CPyStatic__decoding___globals);
        goto CPyL11;
    }
...
CPyL8: ;
    ...
    if (unlikely(cpy_r_r19 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_head_tail", 59, CPyStatic__decoding___globals);
        goto CPyL11;
    }
    ...
    if (unlikely(cpy_r_r23 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_head_tail", 61, CPyStatic__decoding___globals);
        goto CPyL15;
    } else
        goto CPyL16;
CPyL10: ;
...
CPyL1: ;
    ...
    if (likely(PyTuple_Check(cpy_r_r5)))
        ...
        CPy_TypeErrorTraceback("faster_eth_abi/_decoding.py", "decode_tuple", 69, CPyStatic__decoding___globals, "tuple", cpy_r_r5);
        goto CPyL10;
    }
...
PyObject *CPyPy__decoding___decode_tuple(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retval;
fail: ;
    CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_tuple", 67, CPyStatic__decoding___globals);
    return NULL;
}
...
CPyL2: ;
    ...
    cpy_r_r7 = CPyObject_GetAttr(cpy_r_r5, cpy_r_r6);
    if (unlikely(cpy_r_r7 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_sized_array", 78, CPyStatic__decoding___globals);
        goto CPyL20;
    }
...
CPyL6: ;
    ...
    if (unlikely(cpy_r_r12 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_sized_array", 80, CPyStatic__decoding___globals);
        goto CPyL22;
    }
...
CPyL9: ;
    ...
    if (unlikely(cpy_r_r24 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_dynamic_array", 97, CPyStatic__decoding___globals);
        goto CPyL41;
    }
    cpy_r_r25 = 0;
...
CPyL24: ;
    ...
    if (unlikely(cpy_r_r49 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decode_dynamic_array", 99, CPyStatic__decoding___globals);
        goto CPyL44;
    } else
        goto CPyL45;
CPyL25: ;
...
PyObject *CPyDef__decoding___read_fixed_byte_size_data_from_stream(PyObject *cpy_r_self, PyObject *cpy_r_stream) {
    ...
    cpy_r_r1 = CPyObject_GetAttr(cpy_r_self, cpy_r_r0);
    if (unlikely(cpy_r_r1 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "read_fixed_byte_size_data_from_stream", 109, CPyStatic__decoding___globals);
        goto CPyL13;
    }
    if (likely(PyLong_Check(cpy_r_r1)))
        cpy_r_r2 = CPyTagged_FromObject(cpy_r_r1);
    ...
    if (likely(PyBytes_Check(cpy_r_r7) || PyByteArray_Check(cpy_r_r7)))
        ...
        CPy_TypeErrorTraceback("faster_eth_abi/_decoding.py", "read_fixed_byte_size_data_from_stream", 110, CPyStatic__decoding___globals, "bytes", cpy_r_r7);
        goto CPyL15;
    }
    CPy_INCREF(cpy_r_r8);
...
CPyL6: ;
    ...
    if (unlikely(cpy_r_r24 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "read_fixed_byte_size_data_from_stream", 112, CPyStatic__decoding___globals);
        goto CPyL19;
    }
...
PyObject *CPyPy__decoding___read_fixed_byte_size_data_from_stream(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    ...
    return retval;
fail: ;
    CPy_AddTraceback("faster_eth_abi/_decoding.py", "read_fixed_byte_size_data_from_stream", 103, CPyStatic__decoding___globals);
    return NULL;
}

PyObject *CPyDef__decoding___decoder_fn_string(PyObject *cpy_r_data, PyObject *cpy_r_handle_string_errors) {
    PyObject *cpy_r_r0;
    PyObject *cpy_r_r1;
    PyObject *cpy_r_r2;
    PyObject **cpy_r_r4;
    ...
    PyObject *cpy_r_r7;
    PyObject *cpy_r_r8;
    if (cpy_r_handle_string_errors != NULL) goto CPyL6;
    cpy_r_r0 = CPyStatics[9]; /* 'strict' */
    CPy_INCREF(cpy_r_r0);
    cpy_r_handle_string_errors = cpy_r_r0;
CPyL2: ;
    cpy_r_r1 = CPyStatics[42]; /* 'utf-8' */
    cpy_r_r2 = CPyStatics[43]; /* 'decode' */
    PyObject *cpy_r_r3[3] = {cpy_r_data, cpy_r_r1, cpy_r_handle_string_errors};
    cpy_r_r4 = (PyObject **)&cpy_r_r3;
    cpy_r_r5 = CPyStatics[232]; /* ('errors',) */
    cpy_r_r6 = PyObject_VectorcallMethod(cpy_r_r2, cpy_r_r4, 9223372036854775810ULL, cpy_r_r5);
    if (unlikely(cpy_r_r6 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/_decoding.py", "decoder_fn_string", 119, CPyStatic__decoding___globals);
        goto CPyL7;
    }
    CPy_DECREF(cpy_r_handle_string_errors);
    if (likely(PyUnicode_Check(cpy_r_r6)))
        cpy_r_r7 = cpy_r_r6;
    else {
        CPy_TypeErrorTraceback("faster_eth_abi/_decoding.py", "decoder_fn_string", 119, CPyStatic__decoding___globals, "str", cpy_r_r6);
        goto CPyL5;
    }
    return cpy_r_r7;
CPyL5: ;
    ...
    return cpy_r_r8;
CPyL6: ;
    CPy_INCREF(cpy_r_handle_string_errors);
    goto CPyL2;
CPyL7: ;
    CPy_DecRef(cpy_r_handle_string_errors);
    goto CPyL5;
...
PyObject *CPyPy__decoding___decoder_fn_string(PyObject *self, PyObject *const *args, size_t nargs, PyObject *kwnames) {
    static const char * const kwlist[] = {"data", "handle_string_errors", 0};
    static CPyArg_Parser parser = {"O|O:decoder_fn_string", kwlist, 0};
    PyObject *obj_data;
    PyObject *obj_handle_string_errors = NULL;
    if (!CPyArg_ParseStackAndKeywordsSimple(args, nargs, kwnames, &parser, &obj_data, &obj_handle_string_errors)) {
        return NULL;
    }
    PyObject *arg_data;
    ...
    PyObject *arg_handle_string_errors;
    if (obj_handle_string_errors == NULL) {
        arg_handle_string_errors = NULL;
    } else if (likely(PyUnicode_Check(obj_handle_string_errors)))
        arg_handle_string_errors = obj_handle_string_errors;
    else {
        CPy_TypeError("str", obj_handle_string_errors); 
        goto fail;
    }
    PyObject *retval = CPyDef__decoding___decoder_fn_string(arg_data, arg_handle_string_errors);
    return retval;
fail: ;
    CPy_AddTraceback("faster_eth_abi/_decoding.py", "decoder_fn_string", 118, CPyStatic__decoding___globals);
    return NULL;
}
...
CPyL3: ;
    ...
    cpy_r_r10 = CPyStatics[45]; /* 'faster_eth_utils' */
    ...
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[235]; /* ('InsufficientDataBytes',) */
    cpy_r_r14 = CPyStatics[46]; /* 'faster_eth_abi.exceptions' */
    ...
    cpy_r_r18 = CPyStatics[49]; /* 'faster_eth_abi.io' */
...
CPyL4: ;
    ...
    cpy_r_r6 = CPyStatics[50]; /* 'is_dynamic' */
...
CPyL36: ;
    ...
    cpy_r_r74 = CPyStatics[51]; /* 'accumulate' */
...
PyObject *CPyDef__encoding___encode_fixed(PyObject *cpy_r_value, PyObject *cpy_r_encode_fn, char cpy_r_is_big_endian, CPyTagged cpy_r_data_byte_size) {
    ...
    return cpy_r_r10;
CPyL6: ;
    cpy_r_r11 = CPyStatics[215]; /* b'\x00' */
    cpy_r_r12 = CPyStatics[53]; /* 'ljust' */
    CPyTagged_INCREF(cpy_r_data_byte_size);
...
PyObject *CPyDef__encoding___encode_signed(PyObject *cpy_r_value, PyObject *cpy_r_encode_fn, CPyTagged cpy_r_data_byte_size) {
    ...
    return cpy_r_r13;
CPyL8: ;
    cpy_r_r14 = CPyStatics[216]; /* b'\xff' */
    cpy_r_r15 = CPyStatics[52]; /* 'rjust' */
    CPyTagged_INCREF(cpy_r_data_byte_size);
...
CPyL6: ;
    ...
    cpy_r_r11 = CPyStatics[50]; /* 'is_dynamic' */
...
CPyL24: ;
    ...
    cpy_r_r39 = CPyStatics[51]; /* 'accumulate' */
...
PyObject *CPyDef__encoding___encode_uint_256(CPyTagged cpy_r_i) {
    ...
    cpy_r_r2 = CPyStatics[52]; /* 'rjust' */
    cpy_r_r3 = CPyStatics[217]; /* 32 */
...
PyObject *CPyDef__encoding___int_to_big_endian(CPyTagged cpy_r_value) {
    ...
    PyObject *cpy_r_r17;
    PyObject *cpy_r_r18;
    cpy_r_r0 = CPyStatics[54]; /* 'bit_length' */
...
CPyL5: ;
    cpy_r_r9 = 2;
CPyL6: ;
    cpy_r_r10 = CPyStatics[55]; /* 'big' */
    cpy_r_r11 = CPyStatics[56]; /* 'to_bytes' */
    CPyTagged_INCREF(cpy_r_value);
...
CPyL3: ;
    ...
    cpy_r_r6 = CPyStatics[57]; /* 'itertools' */
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r12);
    cpy_r_r13 = CPyStatics[63]; /* 'T' */
    cpy_r_r14 = CPyStatic__encoding___globals;
    cpy_r_r15 = CPyStatics[62]; /* 'TypeVar' */
...
CPyL3: ;
    ...
    cpy_r_r10 = CPyStatics[66]; /* 'faster_eth_abi.codec' */
    ...
    cpy_r_r14 = CPyStatics[68]; /* 'faster_eth_abi.registry' */
    ...
    cpy_r_r18 = CPyStatics[67]; /* 'registry' */
    ...
    cpy_r_r21 = CPyStatics[65]; /* 'ABICodec' */
    ...
    cpy_r_r27 = CPyStatics[69]; /* 'default_codec' */
    ...
    CPy_Unreachable();
CPyL13: ;
    cpy_r_r32 = CPyStatics[70]; /* 'encode' */
    ...
    cpy_r_r35 = CPyStatics[70]; /* 'encode' */
    ...
    CPy_Unreachable();
CPyL18: ;
    cpy_r_r40 = CPyStatics[43]; /* 'decode' */
    ...
    cpy_r_r43 = CPyStatics[43]; /* 'decode' */
    ...
    CPy_Unreachable();
CPyL23: ;
    cpy_r_r48 = CPyStatics[71]; /* 'is_encodable' */
    ...
    cpy_r_r51 = CPyStatics[71]; /* 'is_encodable' */
    ...
    CPy_Unreachable();
CPyL28: ;
    cpy_r_r56 = CPyStatics[72]; /* 'is_encodable_type' */
    ...
    cpy_r_r59 = CPyStatics[72]; /* 'is_encodable_type' */
...
CPyL3: ;
    ...
    CPy_INCREF(CPyModule_typing);
    CPy_DECREF(cpy_r_r8);
    cpy_r_r9 = (CPyTagged)CPyStatics[219] | 1; /* 115792089237316195423570985008687907853269984665640564039457584007913129639936 */
    cpy_r_r10 = CPyStatic_constants___globals;
    cpy_r_r11 = CPyStatics[73]; /* 'TT256' */
    ...
    cpy_r_r15 = (CPyTagged)CPyStatics[220] | 1; /* 115792089237316195423570985008687907853269984665640564039457584007913129639935 */
    cpy_r_r16 = CPyStatic_constants___globals;
    cpy_r_r17 = CPyStatics[74]; /* 'TT256M1' */
    ...
    cpy_r_r21 = (CPyTagged)CPyStatics[221] | 1; /* 57896044618658097711785492504343953926634992332820282019728792003956564819968 */
    cpy_r_r22 = CPyStatic_constants___globals;
    cpy_r_r23 = CPyStatics[75]; /* 'TT255' */
...
CPyL2: ;
    ...
    cpy_r_r3 = CPyStatics[76]; /* 'normalize' */
    ...
    cpy_r_r18 = CPyStatics[78]; /* '' */
    cpy_r_r19 = CPyStatics[79]; /* '{:{}}' */
    cpy_r_r20 = CPyStatics[78]; /* '' */
    cpy_r_r21 = CPyStatics[80]; /* 'format' */
    ...
    cpy_r_r27 = CPyStatics[82]; /* '{!r:{}}' */
    cpy_r_r28 = CPyStatics[78]; /* '' */
    cpy_r_r29 = CPyStatics[80]; /* 'format' */
...
CPyL1: ;
    ...
    cpy_r_r2 = CPyStatics[76]; /* 'normalize' */
...
CPyL3: ;
    ...
    cpy_r_r34 = CPyStatics[62]; /* 'TypeVar' */
    ...
    cpy_r_r45 = CPyStatics[58]; /* 'Callable' */
...
CPyL13: ;
    ...
    CPy_Unreachable();
CPyL18: ;
    cpy_r_r40 = CPyStatics[71]; /* 'is_encodable' */
    cpy_r_r41 = CPyObject_GetAttr(cpy_r_r38, cpy_r_r40);
    if (unlikely(cpy_r_r41 == NULL)) {
        CPy_AddTraceback("faster_eth_abi/packed.py", "<module>", 15, CPyStatic_packed___globals);
        goto CPyL21;
...
CPyL7: ;
    ...
    cpy_r_r14 = CPyStatics[76]; /* 'normalize' */
...
CPyL11: ;
    ...
    cpy_r_r17 = CPyStatics[218]; /* 0 */
    cpy_r_r18 = CPyStatics[218]; /* 0 */
...
CPyL3: ;
    ...
    cpy_r_r27 = CPyStatics[68]; /* 'faster_eth_abi.registry' */
    ...
    cpy_r_r35 = CPyStatics[58]; /* 'Callable' */
    ...
    *(PyObject * *)cpy_r_r44 = cpy_r_r40;
    ...
    cpy_r_r97 = CPyStatics[225]; /* 20 */
    cpy_r_r98 = CPyStatics[225]; /* 20 */
    ...
    cpy_r_r129 = CPyStatics[218]; /* 0 */
    cpy_r_r130 = CPyStatics[226]; /* 4096 */
...
CPyL2: ;
    ...
    cpy_r_r13 = CPyStatics[79]; /* '{:{}}' */
    CPyTagged_INCREF(cpy_r_places);
    cpy_r_r14 = CPyTagged_StealAsObject(cpy_r_places);
    cpy_r_r15 = CPy_TYPE(cpy_r_r14);
    CPy_DECREF(cpy_r_r14);
    cpy_r_r16 = CPyStatics[78]; /* '' */
    cpy_r_r17 = CPyStatics[80]; /* 'format' */
...
const char * const CPyLit_Str[] = {
    ...
    "\006\016data_byte_size\016Tried to read \021 bytes, only got \005utf-8\006decode\006errors",
    ...
    "\004\027faster_eth_abi.registry\rdefault_codec\006encode\fis_encodable",
...
const int CPyLit_Tuple[] = {
    38, 4, 12, 13, 14, 15, 2, 17, 18, 2, 20, 21, 1, 44, 3, 12, 13, 15,
    1, 24, 1, 27, 2, 47, 48, 1, 51, 7, 12, 13, 58, 59, 60, 61, 62, 1, 64,
    1, 65, 1, 67, 3, 101, 101, 101, 1, 242, 6, 12, 13, 58, 60, 104, 62, 1,
    18, 5, 105, 84, 99, 76, 77, 1, 109, 1, 112, 1, 113, 1, 117, 1, 122, 2,
    129, 130, 3, 129, 130, 132, 2, 135, 136, 4, 58, 64, 60, 142, 1, 143,
    1, 146, 1, 125, 6, 148, 149, 150, 120, 151, 152, 1, 153, 1, 173, 3,
    198, 198, 198, 1, 262, 3, 58, 64, 15, 1, 202, 1, 13
};
