from ._grammar import ABIType as ABIType, BasicType as BasicType, TupleType as TupleType, normalize as normalize
...
def parse_type_str(expected_base: str | None = None, with_arrlist: bool = False) -> Callable[[OldFromTypeStr[TType]], 'NewFromTypeStr[TType]']: ...
