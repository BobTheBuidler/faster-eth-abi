from faster_eth_abi.encoding import BaseEncoder as BaseEncoder, TupleEncoder as TupleEncoder
...
def encode_fixed(value: Any, encode_fn: Callable[[Any], bytes], is_big_endian: bool, data_byte_size: int) -> bytes: ...
def encode_signed(value: T, encode_fn: Callable[[T], bytes], data_byte_size: int) -> bytes: ...
